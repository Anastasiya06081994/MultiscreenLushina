package com.example.multiscreenlushina;
...
String[] things = {"Аргентина", "Бразилия", "Колумбия", "Чили", "Уругвай"};
    @Override
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch(position){
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Intent intent3 = new Intent( MainActivity.this, Columbiya.class);
                        startActivity(intent3);
                        break;
                    case 3:
                        Intent intent4 = new Intent( MainActivity.this, Chily.class);
